...
export default function MapClient({ apiKey }: { apiKey: string }) {
  ...
  const [business, setBusiness] = useState({ name: 'İşletme merkezi', address: '', position: defaultPosition })
