...
export default function BankingPage() {
  ...
  return <main className="banking-page"><header className="banking-header"><div className="banking-nav"><Link href="/" className="back-link"><ArrowLeft size={16} /> Ana panele dön</Link><Link href="/finance/companies" className="text-link"><Building2 size={15} /> Firmalar & Cari Hesap</Link></div><div className="banking-heading"><div className="banking-icon"><WalletCards size={24} /></div><div><span className="eyebrow">Finans merkezi</span><h1>Kasa & Banka</h1><p>Türkiye bankalarını demo bağlantı ve ekstre aktarımıyla tek ekranda yönetin.</p></div></div><div className="security-note"><ShieldCheck size={18} /><span>Şifre istemiyoruz. Gerçek bağlantı için sağlayıcı seçildiğinde OAuth kullanılacak.</span></div></header>
